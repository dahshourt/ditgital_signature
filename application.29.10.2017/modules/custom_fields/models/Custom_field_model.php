...
class Custom_field_model extends CI_Model
{
	...
	public function get_access_fields($input_fun)
	{
		...
		$result = $this->db
					->select('cf.label, cf.name, cf.type, cf.related_table, cf.related_table, cfg.sort, cfg.validation_type_id, vt.name  validation_type_name, cf.parent_id, cf.form_id')
