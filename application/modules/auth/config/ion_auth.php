 ...
 */
$config['site_title']                 = "Digital Signature";       // Site Title, example.com
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com
$config['default_group']              = 'CS FL';           // Default group, use name
...
//$config['password_restriction']     = '/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z]{8,}$/';
$config['password_restriction'] 	  = '/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[$@$!%_*?&])/';
															 /*(/^
