...
if ( ! empty($get_access_fields)):
    ...
    echo form_input($ajax_user_id_url);    $ajax_user_id_url = array(
        'type'  => 'hidden',
        'name'  => 'ajax_user_id_url',
        'id'    => 'ajax_user_id_url',
        'value' => $ajax_user_id_url,
    ...
    foreach ($get_access_fields as $value_access_field):
        ...
        if($value_access_field['label'] == "Comment" || $value_access_field['label'] == "Upload file"):
        ...
        if ($value_access_field['type'] == 'dropdown'):
            ...
            if($value_access_field['name'] == "comment" || $value_access_field['type'] == "upload"):
...
<div class="col-lg-12">
    ...
    <tr class="odd gradeX">
        ...
        <td><?php echo anchor('uploads/tickets/'.$file->file_name, 'Download') ;?></td>
    </tr>
<?php endforeach;?>
	                </tbody>
	            </table>
