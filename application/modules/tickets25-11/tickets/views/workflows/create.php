...
<?php endif;
	...
	echo form_open_multipart('tickets/workflows/store');?>
	<div class="col-lg-6">
		...
		<select type="" name="previous_group" id="previous_group" class="form-control">
			...
			<option value="<?php echo $group_val->id; ?>"> <?php echo $group_val->name; ?> </option>
			<?php endforeach; ?>
		</select>
	</div>
	...
	<div class="col-lg-6">
		...
		<select type="" name="problem" id="problem" class="form-control">
			...
			<option value="<?php echo $problem_val->id; ?>"> <?php echo $problem_val->name; ?> </option>
			<?php endif; ?>
			<?php endforeach; ?>
		</select>
	</div>
