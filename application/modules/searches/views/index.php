	...
	<div class="col-lg-12">
		<div class="panel-body">
			...
			<div class="dataTable_wrapper">
				<table class="table table-striped table-bordered table-hover" data-order="[]" id="dataTables-example">
					<thead>
						<tr>
							<th><?= lang('tickets:id') ?></th>
							<th><?= lang('tickets:group') ?></th>
							...
							<th><?= lang('tickets:creator_name') ?></th>
							<th><?= lang('tickets:closed_by') ?></th>
							<th><?= lang('tickets:customer_type') ?></th>
					...
					<tbody>
						<?php foreach ($search_tickets as $search_ticket) : ?>
							<tr class="odd gradeX">
								...
								<td><?= htmlspecialchars($search_ticket->group_name, ENT_QUOTES, 'UTF-8') ?></td>
								...
								<td><?= htmlspecialchars($search_ticket->creator_name, ENT_QUOTES, 'UTF-8') ?></td>
								<td><?= htmlspecialchars($search_ticket->closed_by_user, ENT_QUOTES, 'UTF-8') ?></td> 
								<td><?= htmlspecialchars($search_ticket->customer_type, ENT_QUOTES, 'UTF-8') ?></td>



								<td><?php echo (!empty($search_ticket->status_name != 'Closed') ? anchor("tickets/edit/" . $search_ticket->id, 'Edit') : ''); ?></td>
								<?php //echo anchor("tickets/edit/".$search_ticket->id, 'Edit');
								?>
