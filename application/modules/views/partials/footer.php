...
<script type="text/javascript">
	...
	$(".checkbox-followup").change(function() {
		if(this.checked) {
			$(".form-date-hidden").show();
			$('label[for="form-control form-date-hidden"]').show();
		}
		else
		{
			$(".form-date-hidden").hide();
			$('label[for="form-control form-date-hidden"]').hide();
		}
	});
